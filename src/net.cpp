...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Guarantcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"188.226.132.102", "188.226.132.102"},
    {"162.243.196.52", "162.243.196.52"},
    {"128.199.217.9", "128.199.217.9"},
    {"185.8.236.10", "185.8.236.10"},
    {"31.31.79.94", "31.31.79.94"},
    {"78.108.101.51", "78.108.101.51"},
    {"185.8.236.45", "185.8.236.45"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"gtctestnode.cloudapp.net", "gtctestnode.cloudapp.net"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Guarantcoin is probably already running."), addrBind.ToString().c_str());
        else
